...
def _insert_tone_trigger_map(db, tone_event_id: int, trig_id: int):
    db.execute_commit(
        "INSERT OR IGNORE INTO tone_trigger_map(tone_event_id,alert_trigger_id) VALUES (?,?)",
...
def save_call_transcript(db: SQLiteDatabase, call_id: int, resp: Dict[str, Any]) -> None:
    """
